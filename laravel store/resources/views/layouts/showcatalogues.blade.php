...
<div class="container-fluid">
  ...
  <table class="table table-striped table-hover">
    ...
    <tbody>
      ...
      <tr>
        <td>{{$filiere->id_catalogue}}</td>
        <td>{{$filiere->name}}</td>
        <td>
       
        
          <a href="delete/{{$filiere->id_catalogue}}" class="btn btn-danger btn-sm">delete</a>
          <a href="edit/{{$filiere->id_catalogue}}" class="btn btn-primary btn-sm">Edit</a>
